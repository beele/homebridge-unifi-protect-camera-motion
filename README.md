...
Consult the documentation for more details: [Homebridge Camera FFmpeg configuration](https://github.com/Sunoo/homebridge-camera-ffmpeg#optional-videoconfig-parameters). 
...
# Dependencies:
This plugin makes use of the awesome [Homebridge Camera FFmpeg plugin](https://github.com/Sunoo/homebridge-camera-ffmpeg) for getting the streaming functionality up & running.
Please pay the page a visit, because without all of the effort on their side, this plugin would not be possible!
