...
|videoConfig|object|yes|/|Wrapper object containing the [FFmpeg configuration]([https://github.com/KhaosT/homebridge-camera-ffmpeg#homebridge-camera-ffmpeg](https://github.com/KhaosT/homebridge-camera-ffmpeg#homebridge-camera-ffmpeg)). ***Make sure the fields `source` and `stillImageSource` are omitted as these will be generated by the plugin itself!***|
