...
- Add enhanced detection score for filtering.
- Previews in notifications are made by the Home app, and can thus be 'after the fact' and show an image with nothing of interest on it.
