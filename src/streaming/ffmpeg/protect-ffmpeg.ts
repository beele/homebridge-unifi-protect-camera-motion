...
export class FfmpegProcess extends EventEmitter {
    ...
    protected platform: FakePlatform;
    protected camera: UnifiCamera;
    ...
    constructor(platform: FakePlatform, protectCamera: UnifiCamera, logger: Logging, commandLineArgs?: string[], callback?: StreamRequestCallback) {
    ...
    protected prepareProcess(commandLineArgs?: string[], callback?: StreamRequestCallback): void {
        ...
        if (this.isLogging || this.isVerbose) {
